package com.kaltura.puremvc.as3.core
{
	...
	public class KView extends View
	{
		...
		/**
		 *  Add observer for the given notification
		 * @param notification the notification to listen for
		 * @param notificationHandler the callback function
		 * @param mediator the mediator that listens
		 * 
		 */		
		public function addNotificationInterest(notification:String, notificationHandler:Function, mediator:IMediator):void {
			var observer:Observer = new Observer (notificationHandler, mediator);
			registerObserver( notification, observer);
		}
