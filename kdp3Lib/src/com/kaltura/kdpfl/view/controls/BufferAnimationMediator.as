		...
		override public function handleNotification(note:INotification):void
		{
			...
			switch(noteName)
			{
				...
				case NotificationType.LAYOUT_READY:
					if (_flashvars.usePreloaderBufferAnimation && _flashvars.usePreloaderBufferAnimation=='true' && _flashvars.preloader)
					{
						spinner.setBufferingAnimation(getQualifiedClassName(_flashvars.preloader));
					}
					else
					{
