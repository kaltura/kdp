package com.kaltura.kdpfl.view.controls
{
	...
	public class Watermark extends BaseScrollPane implements IComponent
	{
		...
		public var pausePlayer:Boolean;
		public var watermarkNotification:String = "watermarkClick";
		public var excludeMe : Boolean = true;
		public var dynamicClick : Boolean = false;
		public static const WATERMARK_CLICK : String = "watermarkClick";
		public static const WATERMARK_PAUSE : String = "watermarkPause";
		...
		public function onWatermarkClick(evt:MouseEvent):void
		{
			if(clickPath)
			{
				//for analytics tracks
				dispatchEvent(new Event(WATERMARK_CLICK));
				//pause the player 
				if(pausePlayer)
