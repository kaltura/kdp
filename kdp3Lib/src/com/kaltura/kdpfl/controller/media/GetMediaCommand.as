	...
	public class GetMediaCommand extends AsyncCommand
	{
		...
		override public function execute(notification:INotification):void
		{
			...
			else //else call to the get entry service again
			{
				...
				if( entryId && entryId != "-1" )
				{
					...
					if (_flashvars.streamerType != "auto")
					{
		...
		public function result(data:Object):void
		{
			...
			else
			{
				...
				if (_flashvars.streamerType == "auto" && _mediaProxy.vo.entryExtraData.mediaProtocol && _mediaProxy.vo.entryExtraData.mediaProtocol != "")
				{
					_mediaProxy.vo.mediaProtocol = _mediaProxy.vo.entryExtraData.mediaProtocol;
				}
				if (_mediaProxy.vo.entryExtraData.storageProfileIds && _mediaProxy.vo.entryExtraData.storageProfileIds != "")
				{
					_mediaProxy.vo.availableStorageIds = _mediaProxy.vo.entryExtraData.storageProfileIds.split(",");
				}
			} 
			...
			if(entry && (entry.id != "-1") && (entry.id != null) )
			{
				...
				var cuePoint1 : KalturaAdCuePoint = new KalturaAdCuePoint();
				cuePoint1.adType = KalturaAdType.VIDEO;
				cuePoint1.startTime = 0;
				cuePoint1.protocolType = KalturaAdProtocolType.VAST_2_0;
				cuePoint1.sourceUrl = "http://creativeby2.unicast.com/assets/A2/N21819/M13995/C446947/vast_kaltura.xml";
				var cuePoint2 : KalturaAdCuePoint = new KalturaAdCuePoint();
				cuePoint2.adType = KalturaAdType.VIDEO;
				cuePoint2.startTime = 0;
				cuePoint2.protocolType = KalturaAdProtocolType.VAST_2_0;
				cuePoint2.sourceUrl = "http://ad3.liverail.com/?LR_PUBLISHER_ID=1331&LR_CAMPAIGN_ID=227&LR_SCHEMA=vast2";
				var cuePoint3 : KalturaAdCuePoint = new KalturaAdCuePoint();
				cuePoint3.adType = KalturaAdType.VIDEO;
				cuePoint3.startTime = 0;
				cuePoint3.protocolType = KalturaAdProtocolType.VAST_2_0;
				cuePoint3.sourceUrl = "http://demo.tremormedia.com/proddev/vast/vast_inline_linear.xml";
				
				cuePointsMap[0] = [cuePoint1, cuePoint2, cuePoint3];
				//cuePointsMap[0] = [{ startTime: 0, type: 'ad', name: 'cuePoint1' ,adType: 'video', provider :'vast' , sourceURL: 'http://creativeby2.unicast.com/assets/A2/N21819/M13995/C446947/vast_kaltura.xml'},{ startTime: 0, type: 'ad', name: 'cuePoint2', adType:'video' , provider: 'vast' , sourceURL: 'http://ad3.liverail.com/?LR_PUBLISHER_ID=1331&LR_CAMPAIGN_ID=227&LR_SCHEMA=vast2' },{ startTime: 0, type: 'ad', name: 'cuePoint2', adType:'video' , provider: 'vast' , sourceURL: 'http://demo.tremormedia.com/proddev/vast/vast_inline_linear.xml' }];
				//cuePointsMap[10] = [{ startTime: 0, type: 'ad', name: 'cuePoint2', adType:'video' , provider: 'vast' , sourceURL: 'http://ad3.liverail.com/?LR_PUBLISHER_ID=1331&LR_CAMPAIGN_ID=227&LR_SCHEMA=vast2' },{ startTime: 10, type: 'ad', name: 'cuePoint2', adType:'video' , provider: 'vast' , sourceURL: 'http://demo.tremormedia.com/proddev/vast/vast_inline_linear.xml' }];
				//cuePointsMap[20] = [{ startTime: 5, type: 'ad', name: 'cuePoint2', adType:'video' , provider: 'vast' , sourceURL: 'http://ad.doubleclick.net/pfadx/N270.126913.6102203221521/B3876671.21;dcadv=2215309;sz=0x0;ord=%5btimestamp%5d;dcmt=text/xml' },{ startTime: 20, type: 'ad', name: 'cuePoint2', adType:'video' , provider: 'vast' , sourceURL: 'http://demo.tremormedia.com/proddev/vast/vast_inline_linear.xml' }];
