package com.kaltura.kdpfl.model
{
	...
	public dynamic class FuncsProxy extends Proxy
	{
		 ...
		 * 
		 */		
		public function encodeURIComponent(url : String) : String
		{
...
/* 			var dateNumber:Number = parseInt(dateObject);
		...
		/**
		 * This function applies logic "and" between the two objects
		 * @param obj - first object to evaluate
		 * @param obj2 - second object to evalueate 
		 * @return 
		 * 
		 */	
		public function and(obj:*, obj2:*):Boolean
		{
			var firstObjValue:Boolean = getBooleanValue (obj);
			var secondObjValue:Boolean = getBooleanValue (obj2);
			
			return (firstObjValue && secondObjValue);
		}
		
		/**
		 * This function applies logic "or" between the two objects
		 * @param obj - first object to evaluate
		 * @param obj2 - second object to evalueate 
		 * @return 
		 * 
		 */	
		public function or(obj:*, obj2:*):Boolean
		{
			var firstObjValue:Boolean = getBooleanValue (obj);
			var secondObjValue:Boolean = getBooleanValue (obj2);
		...
		/**
		 * This function returns the boolean value of the given object 
		 * if object is not boolean or String, false will be returned
		 */		
		private function getBooleanValue (obj:*) : Boolean 
		{
			if (obj is Boolean)
