package com.kaltura.kdpfl.model
{
	...
	public class SequenceProxy extends Proxy
	{
		...
		public function playNextInSequence () : void
		{
			...
			else if (vo.midCurrentIndex != -1 && vo.midrollArr && vo.midrollArr.length)
			{
		...
		public function setPrePostMedia(mediaElement:MediaElement):Boolean {
			...
			enableGui(false);
		//	playerMediator.player.addEventListener( MediaPlayerCapabilityChangeEvent.CAN_PLAY_CHANGE , onAdPlayable );
		//	playerMediator.player.addEventListener(TimeEvent.DURATION_CHANGE, onAdDurationReceived, false, int.MIN_VALUE);
