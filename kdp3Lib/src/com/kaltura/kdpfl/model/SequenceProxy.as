package com.kaltura.kdpfl.model
{
	...
	public class SequenceProxy extends Proxy
	{
        ...
        {
        	var cloner : Cloner = new Cloner();
        	(facade.retrieveProxy(MediaProxy.NAME) as MediaProxy).vo = cloner.clone(vo.mainMediaVO) as MediaVO;
        }
         ...
         * 
         */        
        private function addPluginToPrePostArr (plugin : ISequencePlugin) : void
        {
        ...
        public function populatePrePostArr () : void
        {
        	...
        	for each(var comp : * in bindObj)
        	{
        		if ( comp is Plugin )
        		{
	        		...
	        		{
	        			addPluginToPrePostArr(comp.content as ISequencePlugin);
	        		}
        		}
        	}
        }
