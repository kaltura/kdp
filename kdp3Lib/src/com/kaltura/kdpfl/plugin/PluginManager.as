package com.kaltura.kdpfl.plugin
{
	...
	public class PluginManager extends EventDispatcher
	{
		...
		public function loadPlugin( url : String , pluginName : String, loadingPolicy : String, fileSystemMode : Boolean = false ) : Plugin
		{
			if(!_url2PluginMap[url])
			{
				...
				if(loadingPolicy == "wait" || loadingPolicy == "preInitialize") 
				{
