package com.kaltura.kdpfl
{
	...
	public class ApplicationFacade extends Facade implements IFacade
	{
		 ...
		 */		
		public var kdpVersion : String = "v3.4.6";
        ...
        {  
        	...
        	if(debugMode){
				var s:String;
	           if(notificationName != "playerUpdatePlayhead" && notificationName != "bytesDownloadedChange")
	           {
	            	if(notificationName == "playerStateChange")
        	...
        	//in order of listenning to the KDP from another Flash application
		...
		override protected function initializeController():void
		{
			...
			registerCommand (NotificationType.MEDIA_READY, MediaReadyCommand );
