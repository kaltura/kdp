package com.kaltura.osmf.proxy
{
	...
	public class KSwitchingProxyElement extends ProxyElement 
	{
		...
		public function switchElements () : void
		{
			...
			var curDisplayObjectTrait:DisplayObjectTrait = proxiedElement.getTrait(MediaTraitType.DISPLAY_OBJECT) as DisplayObjectTrait;
			if (curDisplayObjectTrait) 
			{
				curDisplayObjectTrait.displayObject.width = 0;
				curDisplayObjectTrait.displayObject.height = 0;
			}
