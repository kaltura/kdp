...
//				this.addChild(this.debugCanvas);
		...
		{	
			...
			if(this.isInvalid(InvalidationType.SIZE, INVALIDATION_TYPE_LAYOUT))
			{
				...
				{
					//TODO Atar - if the graphics if full it blocks the mouse from reaching stuff under the BaseLayoutPane
					// so we draw a blank rect instead - it probably messes the scroll anyway, but whio cares.
