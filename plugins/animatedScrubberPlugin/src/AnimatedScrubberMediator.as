...
package 
{
	 ...
	 * 
	 */
	public class AnimatedScrubberMediator extends Mediator
	{
		public static const NAME:String = "animatedScrubberMediator";
		...
		public function AnimatedScrubberMediator( viewComponent:Object=null )
		{
			...
			scrubber.addEventListener( AnimatedScrubberCode.EVENT_SEEK, onSeek, false, 0, true );
			scrubber.addEventListener( AnimatedScrubberCode.EVENT_SEEK_START, onSeekStart, false, 0, true );
			scrubber.addEventListener( AnimatedScrubberCode.EVENT_SEEK_END, onSeekEnd, false, 0, true );
			scrubber.addEventListener( AnimatedScrubberCode.EVENT_DRAG, onStartDrag, false, 0, true );
			scrubber.addEventListener( AnimatedScrubberCode.EVENT_DRAG_END, onEndDrag, false, 0, true );
		}
		/**
		...
		{
			sendNotification( NotificationType.DO_SEEK, _currSeekPosition );
		...
		public function get scrubber():AnimatedScrubberCode
		{
			return( viewComponent as AnimatedScrubberCode );
		}		
	}
}