package com.kaltura.kdpfl.plugin
{
	...
	public class PPTWidgetVideoMark extends Button
	{
		...
		{
			keyFrameIcon_Over: "keyFrameIcon_Over",
		...
		[Bindable] private var _videoMarkContentText:String;	
		...
		{
			trace("PPTWidgetVideoMark - onMouseDown");
			if (_adminMode) 
			{
		...
		{
			trace("PPTWidgetVideoMark - onMouseUp");
			...
			if (_adminMode)
			{
				...
				var newTime:Number = (event.stageX + _gapX) * _totalTime / parent.width;
