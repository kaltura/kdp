package com.kaltura.kdpfl.plugin
{
	...
	public class PPTWidgetVideoMarksContainer extends UIComponent
	{
		...
		{
			trace("PPTWidgetVideoMarksContainer - onMarkMouseDown");
		...
		public function set totalTime (value:Number):void 
		{
			...
			for (var index:uint = 0; index < numChildren; index++) 
			{
				//VideoMark(getChildAt(index)).totalTime = value;
			}
		}
		...
		public function highlightMarker(videoTime:Number):void
		{
			for (var index:uint = 0; index < numChildren; index++) 
			{
				var videoMark:PPTWidgetVideoMark = (getChildAt(index) as PPTWidgetVideoMark);
