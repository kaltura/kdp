package com.kaltura.kdpfl.plugin.component {
	...
	public class TremorMediator extends SequenceMultiMediator {
		 ...
		 * hopefully. 
		 */
		private var _uglyMidrollStatFlag:Boolean = false;
		 ...
		 * 
		 */
		public function TremorMediator(viewComponent:Object = null, prog:String = "", tracesVolume:String = "FATAL") {
			super(viewComponent);
			if (prog != "")
				progId = prog;
			traces = tracesVolume;
