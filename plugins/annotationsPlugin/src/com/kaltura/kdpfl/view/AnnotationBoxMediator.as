	...
	public class AnnotationBoxMediator extends Mediator
	{
		...
		override public function handleNotification(notification:INotification):void
		{
			...
			switch (name)
			{
				...
				case Notifications.SAVE_ANNOTATION:
					...
					{
						var feedbackSessionXml : XML = (viewComponent as annotationsPluginCode).annotationsBox.annotationsXML(AnnotationStrings.DRAFT);
		...
		protected function submitFeedbackSession (kalturaAnnotationsArray : Array) : void
		{
			...
			function onFeedbackSaved (e : KalturaEvent=null) : void
			{
				...
				{
					var feedbackSessionXml : XML = (viewComponent as annotationsPluginCode).annotationsBox.annotationsXML(AnnotationStrings.FINAL);
					sendNotification (Notifications.FEEDBACK_SESSION_SUBMITTED, {feedbackSessionXML: feedbackSessionXml});
