package com.kaltura.kdpfl.view
{
	...
	public dynamic class AnnotationsBox extends KVBox
	{
		 ...
		 * 
		 */		
		public function annotationsXML (saveMode : String) : XML
		{
			var dpArray : Array = dataProvider.toArray();
			var entryId : String = "";
			if (dpArray && dpArray.length)
				entryId = (dpArray[0]["annotation"] as Annotation).entryId;

				
			var partnerId : int =  (dpArray[0]["annotation"] as Annotation).kalturaAnnotation.partnerId;
