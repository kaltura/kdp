package
{
	...
	public dynamic class ComscorePluginCode extends Sprite implements IPlugin
	{
		 ...
		 */
		protected function onXmlFail(e:IOErrorEvent=null):void
		{
...
/*			for each(node in children)
		...
		{
			return (xmlMap) ? parseCAttribute("c3") : _c3;
		...
		{
			return (xmlMap) ? parseCAttribute("c4") : _c4;
		}
		...
		{
			return (xmlMap) ? parseCAttribute("c5") : _c5;
		}
		...
		{
			return (xmlMap)? parseCAttribute("c6") : _c6;
		}
