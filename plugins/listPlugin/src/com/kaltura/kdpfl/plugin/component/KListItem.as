...
public class KListItem extends CellRenderer
{
	...
	public static function getStyles():Object
	{
		if (stylName)
		{
			...
			for (var style:String in defaultStyles)
			{
				var value:String = defaultStyles[style] as String;
				if (value && value.indexOf("_")!=-1)
				{
					value = value.replace(value.substr(value.lastIndexOf("_") + 1), stylName);
				}
		
				stylesObj[style] = value;
			}
			return stylesObj;
		}
