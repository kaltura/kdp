package com.kaltura.kdpfl.plugin
{
	...
	{ 
		...
		protected function onPresentationLoadFailed (e : Event) : void
		{
			trace ();
		}
		...
		{ 
			//if (v) _carousel.dataProvider = v;
			//_carousel.dataProvider = v;
		...
		public function set presentationPath(value:String):void
		{
 			...
 			if (_presentationPath && _presentationPath != "" )
			{
				...
				_loader.addEventListener( IOErrorEvent.IO_ERROR, onPresentationLoadFailed );
				_loader.contentLoaderInfo.addEventListener ( IOErrorEvent.IO_ERROR, onPresentationLoadFailed );
