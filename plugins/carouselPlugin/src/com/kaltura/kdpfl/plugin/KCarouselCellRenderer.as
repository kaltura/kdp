package com.kaltura.kdpfl.plugin
{
	...
	public class KCarouselCellRenderer extends CarouselCellRenderer 
	{
		...
		override public function set data(arg0:Object):void
		{
			...
			_shouldReloadThumbMC = updatedThumbMC;
			
			if (_shouldReloadThumbMC && this.isInvalid(InvalidationType.DATA))
			{
		...
		protected function onThumbMCError (e : Event) : void
		{
		...
		protected function onMouseOver(event:MouseEvent):void
		{
			...
			/*_overBitmap.contentLoaderInfo.addEventListener( Event.COMPLETE, onOverThumbLoaded );
			_overBitmap.contentLoaderInfo.addEventListener( IOErrorEvent.IO_ERROR, onOverThumbLoaded );
			_overBitmap.loadBytes( this.data.source.loaderInfo.bytes );*/
