package com.kaltura.kdpfl.plugin.component
{
	 ...
	 */
	public class AdaptvAS3Player extends Sprite{	
		...
		private var adPlayerURL:String = "http://redir.adap.tv/redir/client/static/AS3AdPlayer.swf";				
		...
		private var _adPlayerLoadingTimer : Timer;
		private var statusMethod:Function;
				 										
		public function AdaptvAS3Player(config:Object, adaptvintegrate:String = undefined):void {	
			...
			_adPlayerLoadingTimer = new Timer(10000, 1);
...
/* 			if (!isLoaded){
		...
		private function handleAdPlayerLoaded(event:Event):void {	
			...
			adPlayer.setContentSize(playerFrame.width, playerFrame.height, false);
			//Required if HTML integrated:
			adPlayer.setHTMLSize(playerFrame.width, playerFrame.height, playerFrame.x, playerFrame.y);
			adPlayer.x = playerFrame.x;
			adPlayer.y = playerFrame.y;
