package com.kaltura.kdpfl.plugin.component
{
	...
	public class NielsenVideoCensusMediator extends Mediator
	{
		...
		private var prevStartTime:Number	= 0;
		private var newStartTime:Number		= 0;
		override public function handleNotification(note:INotification):void
		{
			var data:Object = note.getBody();
			_currentTime				= 1000*Number(facade["bindObject"]["video"].player.currentTime);
			switch(note.getName()) 
			{
				case "playerPlayed":
							eventData	= new Object();
							eventData["segmentId"]	= _segmentsCounter;
							eventData["length"]		= Number(newStartTime - prevStartTime);
				...
				case NotificationType.MID_SEQUENCE_COMPLETE:
					...
					newStartTime						= 1000*Number(facade["bindObject"]["video"].player.currentTime);
					break;
				default:
