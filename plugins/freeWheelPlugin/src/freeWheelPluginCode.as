	...
	public class freeWheelPluginCode extends Sprite implements IPlugin, ISequencePlugin, IMidrollSequencePlugin
	{
		...
		public function initializePlugin(facade:IFacade):void
		{
			...
			if (this.parameters.adManagerUrl){
				...
				this.amLoader.loadAdManager(this, amLoaded, AdManagerLoader.LEVEL_DEBUG, this.parameters.adManagerUrl, 0);
			}
			else{
		...
		private function configAm():void{
			...
			if (useKalturaTemporalSlots) {
				...
				//add empty pre & post rolls, to always play them
				/*	this.am.addTemporalSlot('generic_preroll',
				this.constants.ADUNIT_PREROLL, 0, null, 0, 0, null, null, null, 0, 0);
				this.am.addTemporalSlot('generic_postroll',
				this.constants.ADUNIT_POSTROLL,mediaProxy.vo.entry.msDuration, null, 0, 0, null, null, null, 0, 0);*/
			}
