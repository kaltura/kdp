package {
	...
	public class plymediaPluginCode extends UIComponent implements IPlugin
	{
		...
		[Bindable] public var subtitlesButtonVisible:Boolean = false;
		//by default the host will be www.kaltura.com
		public var useHost:Boolean = false;
		//by default the Plymedia menu will be visible
		public var menuVisible:Boolean = true;
		public var languages:String = "";
		//if true then language will be displayed from the begining, otherwise the video will start with
		//no subtitles
