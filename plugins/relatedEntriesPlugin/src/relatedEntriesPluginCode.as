package
{
	...
	public class relatedEntriesPluginCode extends UIComponent implements IPlugin
	{
		...
		/**
		 * data for the related entries source.Can be playlist ID, list of entries, list of reference IDs 
		 */		
		...
		public function startAction():void 
		{
			switch (itemClickAction)
			{
				...
				case RelatedItemActionType.GO_TO_URL:
					var funcProxy:FuncsProxy = _facade.retrieveProxy(FuncsProxy.NAME) as FuncsProxy;
