...
import com.kaltura.kdpfl.plugin.component.ScrubberPluginMediator;
 ...
 * 
 */
public dynamic class ScrubberPluginCode extends UIComponent implements IComponent, IPlugin
{			
...
//--------------------------------------
	...
	private var _thumbPosition:Point	= new Point(0,0);
	
	/**
	 * Set to true if only if we want to send one seek event to the player. 
	 * Otherwise under Akamai HD, seeking to a specific time may not be reliable. 
	 * **/
	public var seekOnce:Boolean		= true;
	...
	public function set thumbPosition(val:Point):void{
		_thumbPosition		= this.localToGlobal(val);
	}
...
//--------------------------------------
     ...
     * @playerversion Flash 9.0.28.0
     */
	public function ScrubberPluginCode()
	{
		super();
		_scrubbing = false;
...
//		var _tempSkin:ScrubberTempSkin = new ScrubberTempSkin;
	...
	public function initializePlugin( facade : IFacade ) : void{
		var mediator:ScrubberPluginMediator 	= new ScrubberPluginMediator(this);
	...
	override protected function draw():void
	{
		...
		thumbPosition	= new Point(_thumb.x, _thumb.y);
...
//		_scrubButton.height = _scrubButton.width = height/2;
	...
	private var newSeekTime:Number	= -1;
	...
	public var finalSeekPositionSet:Boolean	= false;
	 ...
	 * @param event MouseEvent
	 */		 
	protected function scrubButtonMouseDownHandler(event:MouseEvent = null):void
	{
		finalSeekPositionSet =	 false;
	...
	/**
	 * When sending too many seek events using Akamai HD, seek time becomes unreliable.
	 * So we grab a final seek time when mouse up occurs. This is the actual value sent to the player. 
	 * 
	 * **/
	protected function getFinalSeekTime():void{
		//check if this is a track click or a button click
		//if(event.target is BaseButton)
		_isDragging = true;
		var evtDragStart:Event = new Event( EVENT_DRAG, true, true );
	 ...
	 * @param event MouseEvent
	 */	
	protected function scrubButtonMouseUpHandler(event:MouseEvent=null):void
	{
