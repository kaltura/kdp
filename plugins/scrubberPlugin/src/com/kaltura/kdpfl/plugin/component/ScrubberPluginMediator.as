...
package com.kaltura.kdpfl.plugin.component
{
	 ...
	 * 
	 */
	public class ScrubberPluginMediator extends Mediator
	{
		...
		public function ScrubberPluginMediator( viewComponent:Object=null )
		{
			...
			scrubber.addEventListener( ScrubberPluginCode.EVENT_SEEK, onSeek, false, 0, true );
			scrubber.addEventListener( ScrubberPluginCode.EVENT_SEEK_START, onSeekStart, false, 0, true );
			scrubber.addEventListener( ScrubberPluginCode.EVENT_SEEK_END, onSeekEnd, false, 0, true );
			scrubber.addEventListener( ScrubberPluginCode.EVENT_DRAG, onStartDrag, false, 0, true );
			scrubber.addEventListener( ScrubberPluginCode.EVENT_DRAG_END, onEndDrag, false, 0, true );
		}
		/**
		...
		/**
		 *  Handler for the <code> ScrubberPluginCode.EVENT_SEEK_START</code> event.
		 * @param evt - event of type  ScrubberPluginCode.EVENT_SEEK_STAR
		 * 
		 */
		private function onSeek( evt:Event =null):void
		{
			if(!scrubber.finalSeekPositionSet && scrubber.seekOnce)
				return;
		...
		/**
		 *  Handler for the <code> ScrubberPluginCode.EVENT_SEEK_END</code> event.
		 * @param evt - event of type  ScrubberPluginCode.EVENT_SEEK_END
		 *	 
		 */
		private function onSeekEnd( evt:Event ):void
		{
			sendNotification( NotificationType.DO_SEEK, scrubber.getPosition() );
		...
		public function get scrubber():ScrubberPluginCode
		{
			return( viewComponent as ScrubberPluginCode );
		}		
	}
}