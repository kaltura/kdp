...
{	
	...
	public class AdaptvMediator extends SequenceMultiMediator
	{
		...
		//private var _callbackObject:CallbackObject;
		...
		/* private var _preSequenceNotificationStartName:String ="";
		private var _preSequenceNotificationEndName:String ="";
		private var _postSequenceNotificationStartName:String ="";
		private var _postSequenceNotificationEndName:String =""; */
...
//		public function init(facade:Object):void
		{
			Security.allowDomain("*");
			var config:Object = {};
			//_callbackObject = new CallbackObject(facade as IFacade);
			//_callbackObject.setResumeEvent(k_pre_dispatch);
		...
		{
			var notify:Array = new Array("playerUpdatePlayhead",
						"mediaReady",
						"durationChange",
						"playerPlayEnd",
						"playerPlayed",
	...
	//		_adManager.contentEnd();	
		...
		private function onTimer(event:TimerEvent):void {
			if(_adaptvPlayer)
				_adaptvPlayer.setStatus({time: _playheadTime, complete: _isComplete});
		}		
