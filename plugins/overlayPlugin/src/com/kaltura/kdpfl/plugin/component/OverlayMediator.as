package com.kaltura.kdpfl.plugin.component {
	...
	public class OverlayMediator extends Mediator {
		...
		override public function listNotificationInterests():Array {
			var notes:Array = ["mediaReady", "playerUpdatePlayhead", "changeMedia", "playerPlayEnd", "doPlay", "doPause", "showOverlayOnCuePoint","changeOverlayDisplayDuration" ];
			return notes;
		}
		...
		override public function handleNotification(notification:INotification):void {
			...
			switch (notification.getName()) {
				...
				case "changeOverlayDisplayDuration":
					...
					if (notification.getBody().newDuration && notification.getBody().newDuration > 0)
						(viewComponent as overlayPluginCode).displayDuration = notification.getBody().newDuration;
