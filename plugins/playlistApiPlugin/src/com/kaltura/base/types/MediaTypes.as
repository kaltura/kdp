...
package com.kaltura.base.types
{
	...
	/**
	 * MediaTypes defines all media types avilable for the kaltura server.
	 */
	public class MediaTypes
	{
		...
		static public function getLocaleMediaType (int_type:uint):String
		{
			...
			var localedType:String = ResourceManager.getInstance().getString(localeBundleName, mediaTypeStr);
