...
package com.kaltura.assets.assets
{
	...
	final public class VideoAsset extends AbstractAsset
	{
		/**
		 * Constructor.
		 ...
		 *
		 */
		public function VideoAsset( asset_uid:String,
								entry_id:String,
								entry_name:String,
								thumb_url:String,
								media_url:String,
		...
		public override function set maxLength(maxLen:Number):void
		{
			throw new ArgumentError("Asset's maxlength can not be set to VIDEO type asset");
		}
