...
package com.kaltura.assets.assets
{
	...
	final public class PluginAsset extends AbstractAsset
	{
		/**
		 * Constructor.
		 ...
		 *
		 */
		public function PluginAsset( asset_uid:String,
								entry_id:String,
								entry_name:String,
								thumb_url:String,
								media_url:String,
		...
		public override function set length (asset_length:Number):void
		{
			super.length = asset_length;
		}
		public override function set maxLength(maximum_length:Number):void
		{
