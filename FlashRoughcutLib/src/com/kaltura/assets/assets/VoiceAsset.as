...
package com.kaltura.assets.assets
{
	...
	final public class VoiceAsset extends AbstractAsset
	{
		/**
		 * Constructor.
		 ...
		 *
		 */
		public function VoiceAsset( asset_uid:String,
								entry_id:String,
								entry_name:String,
								thumb_url:String,
								media_url:String,
		...
		{
			throw new ArgumentError("Asset's maxlength can not be set to VOICE type asset");
		}
