package {
	...
	[SWF(backgroundColor=0xEEEEEE, frameRate=60)]
	public class kdp3 extends Sprite
	{	
		/**
		 ...
		 * 
		 */		
		public function set flashvars( obj : Object ) : void { _flashvars = obj; }
		...
		override public function addChild(child:DisplayObject):DisplayObject
		{
			...
			if( ! (child is PreLoader) )
			{
				...
				{
					if(this.getChildAt(i) is PreLoader)
					{
