package com.kaltura.delegates.virusScanBatch
{
	...
	public class VirusScanBatchGetExclusiveBulkDownloadJobsDelegate extends WebDelegateBase
	{
		public function VirusScanBatchGetExclusiveBulkDownloadJobsDelegate(call:KalturaCall, config:KalturaConfig)
		{
			super(call, config);
		}
