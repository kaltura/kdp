package com.kaltura.delegates.virusScanBatch
{
	...
	public class VirusScanBatchGetExclusivePostConvertJobsDelegate extends WebDelegateBase
	{
		public function VirusScanBatchGetExclusivePostConvertJobsDelegate(call:KalturaCall, config:KalturaConfig)
		{
			super(call, config);
		}
