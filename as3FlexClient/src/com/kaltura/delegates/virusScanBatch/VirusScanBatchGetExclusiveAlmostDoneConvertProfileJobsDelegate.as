package com.kaltura.delegates.virusScanBatch
{
	...
	public class VirusScanBatchGetExclusiveAlmostDoneConvertProfileJobsDelegate extends WebDelegateBase
	{
		public function VirusScanBatchGetExclusiveAlmostDoneConvertProfileJobsDelegate(call:KalturaCall, config:KalturaConfig)
		{
			super(call, config);
		}
