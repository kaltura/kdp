package com.kaltura.delegates.virusScanBatch
{
	...
	public class VirusScanBatchGetExclusiveProvisionProvideJobsDelegate extends WebDelegateBase
	{
		public function VirusScanBatchGetExclusiveProvisionProvideJobsDelegate(call:KalturaCall, config:KalturaConfig)
		{
			super(call, config);
		}
