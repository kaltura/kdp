package com.kaltura.delegates.virusScanBatch
{
	...
	public class VirusScanBatchGetExclusiveAlmostDoneDelegate extends WebDelegateBase
	{
		public function VirusScanBatchGetExclusiveAlmostDoneDelegate(call:KalturaCall, config:KalturaConfig)
		{
			super(call, config);
		}
