package com.kaltura.delegates.virusScanBatch
{
	...
	public class VirusScanBatchGetExclusiveAlmostDoneConvertCollectionJobsDelegate extends WebDelegateBase
	{
		public function VirusScanBatchGetExclusiveAlmostDoneConvertCollectionJobsDelegate(call:KalturaCall, config:KalturaConfig)
		{
			super(call, config);
		}
