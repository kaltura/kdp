package com.kaltura.delegates.virusScanBatch
{
	...
	public class VirusScanBatchGetExclusiveJobsDelegate extends WebDelegateBase
	{
		public function VirusScanBatchGetExclusiveJobsDelegate(call:KalturaCall, config:KalturaConfig)
		{
			super(call, config);
		}
