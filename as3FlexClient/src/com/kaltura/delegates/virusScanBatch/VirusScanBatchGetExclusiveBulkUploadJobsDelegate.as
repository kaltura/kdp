package com.kaltura.delegates.virusScanBatch
{
	...
	public class VirusScanBatchGetExclusiveBulkUploadJobsDelegate extends WebDelegateBase
	{
		public function VirusScanBatchGetExclusiveBulkUploadJobsDelegate(call:KalturaCall, config:KalturaConfig)
		{
			super(call, config);
		}
