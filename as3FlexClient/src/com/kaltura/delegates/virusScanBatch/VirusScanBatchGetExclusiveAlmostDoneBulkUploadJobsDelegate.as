package com.kaltura.delegates.virusScanBatch
{
	...
	public class VirusScanBatchGetExclusiveAlmostDoneBulkUploadJobsDelegate extends WebDelegateBase
	{
		public function VirusScanBatchGetExclusiveAlmostDoneBulkUploadJobsDelegate(call:KalturaCall, config:KalturaConfig)
		{
			super(call, config);
		}
