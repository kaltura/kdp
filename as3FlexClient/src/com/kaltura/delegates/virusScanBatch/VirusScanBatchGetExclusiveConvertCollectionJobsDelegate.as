package com.kaltura.delegates.virusScanBatch
{
	...
	public class VirusScanBatchGetExclusiveConvertCollectionJobsDelegate extends WebDelegateBase
	{
		public function VirusScanBatchGetExclusiveConvertCollectionJobsDelegate(call:KalturaCall, config:KalturaConfig)
		{
			super(call, config);
		}
