package com.kaltura.delegates.virusScanBatch
{
	...
	public class VirusScanBatchGetExclusiveAlmostDoneProvisionProvideJobsDelegate extends WebDelegateBase
	{
		public function VirusScanBatchGetExclusiveAlmostDoneProvisionProvideJobsDelegate(call:KalturaCall, config:KalturaConfig)
		{
			super(call, config);
		}
