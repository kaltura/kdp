...
package com.kaltura.delegates.media
{
	...
	import com.kaltura.commands.media.MediaBulkUploadAdd;
	...
	public class MediaBulkUploadAddDelegate extends WebDelegateBase
	{
		protected var mrloader:MultipartURLLoader;

		public function MediaBulkUploadAddDelegate(call:KalturaCall, config:KalturaConfig)
		{
			super(call, config);
		}
		...
		override protected function sendRequest():void {
			...
			if ((call as MediaBulkUploadAdd).fileData is FileReference) {
				...
				((call as MediaBulkUploadAdd).fileData as FileReference).upload(urlRequest,"fileData");
			}
			else{
				mrloader.addFile(((call as MediaBulkUploadAdd).fileData as ByteArray), UIDUtil.createUID(), 'fileData');	
