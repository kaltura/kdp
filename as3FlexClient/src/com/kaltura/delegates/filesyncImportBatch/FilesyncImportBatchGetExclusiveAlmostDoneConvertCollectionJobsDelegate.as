package com.kaltura.delegates.filesyncImportBatch
{
	...
	public class FilesyncImportBatchGetExclusiveAlmostDoneConvertCollectionJobsDelegate extends WebDelegateBase
	{
		public function FilesyncImportBatchGetExclusiveAlmostDoneConvertCollectionJobsDelegate(call:KalturaCall, config:KalturaConfig)
		{
			super(call, config);
		}
