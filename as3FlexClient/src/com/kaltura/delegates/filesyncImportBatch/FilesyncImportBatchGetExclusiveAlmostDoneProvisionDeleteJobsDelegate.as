package com.kaltura.delegates.filesyncImportBatch
{
	...
	public class FilesyncImportBatchGetExclusiveAlmostDoneProvisionDeleteJobsDelegate extends WebDelegateBase
	{
		public function FilesyncImportBatchGetExclusiveAlmostDoneProvisionDeleteJobsDelegate(call:KalturaCall, config:KalturaConfig)
		{
			super(call, config);
		}
