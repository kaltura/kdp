package com.kaltura.delegates.filesyncImportBatch
{
	...
	public class FilesyncImportBatchGetExclusiveAlmostDoneProvisionProvideJobsDelegate extends WebDelegateBase
	{
		public function FilesyncImportBatchGetExclusiveAlmostDoneProvisionProvideJobsDelegate(call:KalturaCall, config:KalturaConfig)
		{
			super(call, config);
		}
