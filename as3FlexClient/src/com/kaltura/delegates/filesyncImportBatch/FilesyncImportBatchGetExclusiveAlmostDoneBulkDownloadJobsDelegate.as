package com.kaltura.delegates.filesyncImportBatch
{
	...
	public class FilesyncImportBatchGetExclusiveAlmostDoneBulkDownloadJobsDelegate extends WebDelegateBase
	{
		public function FilesyncImportBatchGetExclusiveAlmostDoneBulkDownloadJobsDelegate(call:KalturaCall, config:KalturaConfig)
		{
			super(call, config);
		}
