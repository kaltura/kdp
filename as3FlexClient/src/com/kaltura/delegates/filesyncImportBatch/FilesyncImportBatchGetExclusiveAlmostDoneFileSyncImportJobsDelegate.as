package com.kaltura.delegates.filesyncImportBatch
{
	...
	public class FilesyncImportBatchGetExclusiveAlmostDoneFileSyncImportJobsDelegate extends WebDelegateBase
	{
		public function FilesyncImportBatchGetExclusiveAlmostDoneFileSyncImportJobsDelegate(call:KalturaCall, config:KalturaConfig)
		{
			super(call, config);
		}
