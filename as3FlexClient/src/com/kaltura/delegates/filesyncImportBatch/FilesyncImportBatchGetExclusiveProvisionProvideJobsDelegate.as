package com.kaltura.delegates.filesyncImportBatch
{
	...
	public class FilesyncImportBatchGetExclusiveProvisionProvideJobsDelegate extends WebDelegateBase
	{
		public function FilesyncImportBatchGetExclusiveProvisionProvideJobsDelegate(call:KalturaCall, config:KalturaConfig)
		{
			super(call, config);
		}
