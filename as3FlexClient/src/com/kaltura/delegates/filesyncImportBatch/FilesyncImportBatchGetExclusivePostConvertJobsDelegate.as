package com.kaltura.delegates.filesyncImportBatch
{
	...
	public class FilesyncImportBatchGetExclusivePostConvertJobsDelegate extends WebDelegateBase
	{
		public function FilesyncImportBatchGetExclusivePostConvertJobsDelegate(call:KalturaCall, config:KalturaConfig)
		{
			super(call, config);
		}
