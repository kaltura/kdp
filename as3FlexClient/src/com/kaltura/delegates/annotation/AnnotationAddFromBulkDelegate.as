...
package com.kaltura.delegates.annotation
{
	...
	import com.kaltura.commands.annotation.AnnotationAddFromBulk;
	...
	public class AnnotationAddFromBulkDelegate extends WebDelegateBase
	{
		protected var mrloader:MultipartURLLoader;

		public function AnnotationAddFromBulkDelegate(call:KalturaCall, config:KalturaConfig)
		{
			super(call, config);
		}
		...
		override protected function sendRequest():void {
			...
			if ((call as AnnotationAddFromBulk).fileData is FileReference) {
				(call as AnnotationAddFromBulk).fileData.addEventListener(DataEvent.UPLOAD_COMPLETE_DATA,onDataComplete);
