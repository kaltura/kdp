...
package com.kaltura.delegates.systemPartner
{
	...
	public class SystemPartnerGetPackagesClassOfServiceDelegate extends WebDelegateBase
	{
		public function SystemPartnerGetPackagesClassOfServiceDelegate(call:KalturaCall, config:KalturaConfig)
		{
			super(call, config);
		}
