package com.kaltura.delegates.thumbAsset
{
	...
	public class ThumbAssetAddFromByteArrayDelegate extends WebDelegateBase
	{
		protected var mrloader:MultipartURLLoader;
		
		public function ThumbAssetAddFromByteArrayDelegate(call:KalturaCall, config:KalturaConfig)
		{
			super(call, config);
		}
