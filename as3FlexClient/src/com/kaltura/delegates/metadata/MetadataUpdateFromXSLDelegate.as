...
package com.kaltura.delegates.metadata
{
	...
	import com.kaltura.commands.metadata.MetadataUpdateFromXSL;
	...
	public class MetadataUpdateFromXSLDelegate extends WebDelegateBase
	{
		protected var mrloader:MultipartURLLoader;

		public function MetadataUpdateFromXSLDelegate(call:KalturaCall, config:KalturaConfig)
		{
			super(call, config);
		}
		...
		override protected function sendRequest():void {
			...
			if ((call as MetadataUpdateFromXSL).xslFile is FileReference) {
				(call as MetadataUpdateFromXSL).xslFile.addEventListener(DataEvent.UPLOAD_COMPLETE_DATA,onDataComplete);
