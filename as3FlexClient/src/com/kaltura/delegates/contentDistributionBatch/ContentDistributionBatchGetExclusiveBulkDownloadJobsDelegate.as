package com.kaltura.delegates.contentDistributionBatch
{
	...
	public class ContentDistributionBatchGetExclusiveBulkDownloadJobsDelegate extends WebDelegateBase
	{
		public function ContentDistributionBatchGetExclusiveBulkDownloadJobsDelegate(call:KalturaCall, config:KalturaConfig)
		{
			super(call, config);
		}
