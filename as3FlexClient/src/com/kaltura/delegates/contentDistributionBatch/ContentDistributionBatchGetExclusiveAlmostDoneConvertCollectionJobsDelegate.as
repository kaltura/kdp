package com.kaltura.delegates.contentDistributionBatch
{
	...
	public class ContentDistributionBatchGetExclusiveAlmostDoneConvertCollectionJobsDelegate extends WebDelegateBase
	{
		public function ContentDistributionBatchGetExclusiveAlmostDoneConvertCollectionJobsDelegate(call:KalturaCall, config:KalturaConfig)
		{
			super(call, config);
		}
