package com.kaltura.delegates.contentDistributionBatch
{
	...
	public class ContentDistributionBatchGetExclusiveDistributionFetchReportJobsDelegate extends WebDelegateBase
	{
		public function ContentDistributionBatchGetExclusiveDistributionFetchReportJobsDelegate(call:KalturaCall, config:KalturaConfig)
		{
			super(call, config);
		}
