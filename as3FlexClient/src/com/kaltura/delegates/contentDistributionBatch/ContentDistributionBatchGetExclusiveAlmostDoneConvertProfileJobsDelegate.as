package com.kaltura.delegates.contentDistributionBatch
{
	...
	public class ContentDistributionBatchGetExclusiveAlmostDoneConvertProfileJobsDelegate extends WebDelegateBase
	{
		public function ContentDistributionBatchGetExclusiveAlmostDoneConvertProfileJobsDelegate(call:KalturaCall, config:KalturaConfig)
		{
			super(call, config);
		}
