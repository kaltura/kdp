package com.kaltura.delegates.contentDistributionBatch
{
	...
	public class ContentDistributionBatchGetExclusiveAlmostDoneBulkUploadJobsDelegate extends WebDelegateBase
	{
		public function ContentDistributionBatchGetExclusiveAlmostDoneBulkUploadJobsDelegate(call:KalturaCall, config:KalturaConfig)
		{
			super(call, config);
		}
