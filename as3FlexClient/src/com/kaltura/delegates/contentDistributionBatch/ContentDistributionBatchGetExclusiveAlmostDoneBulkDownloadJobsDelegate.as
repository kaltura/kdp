package com.kaltura.delegates.contentDistributionBatch
{
	...
	public class ContentDistributionBatchGetExclusiveAlmostDoneBulkDownloadJobsDelegate extends WebDelegateBase
	{
		public function ContentDistributionBatchGetExclusiveAlmostDoneBulkDownloadJobsDelegate(call:KalturaCall, config:KalturaConfig)
		{
			super(call, config);
		}
