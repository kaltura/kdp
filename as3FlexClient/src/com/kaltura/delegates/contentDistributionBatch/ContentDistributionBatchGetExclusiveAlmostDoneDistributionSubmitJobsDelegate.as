package com.kaltura.delegates.contentDistributionBatch
{
	...
	public class ContentDistributionBatchGetExclusiveAlmostDoneDistributionSubmitJobsDelegate extends WebDelegateBase
	{
		public function ContentDistributionBatchGetExclusiveAlmostDoneDistributionSubmitJobsDelegate(call:KalturaCall, config:KalturaConfig)
		{
			super(call, config);
		}
