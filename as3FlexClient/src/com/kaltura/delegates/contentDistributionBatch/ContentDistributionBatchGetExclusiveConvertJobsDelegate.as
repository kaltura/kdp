package com.kaltura.delegates.contentDistributionBatch
{
	...
	public class ContentDistributionBatchGetExclusiveConvertJobsDelegate extends WebDelegateBase
	{
		public function ContentDistributionBatchGetExclusiveConvertJobsDelegate(call:KalturaCall, config:KalturaConfig)
		{
			super(call, config);
		}
