package com.kaltura.delegates.contentDistributionBatch
{
	...
	public class ContentDistributionBatchGetExclusiveAlmostDoneDistributionFetchReportJobsDelegate extends WebDelegateBase
	{
		public function ContentDistributionBatchGetExclusiveAlmostDoneDistributionFetchReportJobsDelegate(call:KalturaCall, config:KalturaConfig)
		{
			super(call, config);
		}
