package com.kaltura.delegates.contentDistributionBatch
{
	...
	public class ContentDistributionBatchGetExclusiveAlmostDoneDelegate extends WebDelegateBase
	{
		public function ContentDistributionBatchGetExclusiveAlmostDoneDelegate(call:KalturaCall, config:KalturaConfig)
		{
			super(call, config);
		}
