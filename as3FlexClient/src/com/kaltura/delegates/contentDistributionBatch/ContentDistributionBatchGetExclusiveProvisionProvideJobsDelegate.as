package com.kaltura.delegates.contentDistributionBatch
{
	...
	public class ContentDistributionBatchGetExclusiveProvisionProvideJobsDelegate extends WebDelegateBase
	{
		public function ContentDistributionBatchGetExclusiveProvisionProvideJobsDelegate(call:KalturaCall, config:KalturaConfig)
		{
			super(call, config);
		}
