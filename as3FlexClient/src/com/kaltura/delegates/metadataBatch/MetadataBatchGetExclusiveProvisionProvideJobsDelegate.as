package com.kaltura.delegates.metadataBatch
{
	...
	public class MetadataBatchGetExclusiveProvisionProvideJobsDelegate extends WebDelegateBase
	{
		public function MetadataBatchGetExclusiveProvisionProvideJobsDelegate(call:KalturaCall, config:KalturaConfig)
		{
			super(call, config);
		}
