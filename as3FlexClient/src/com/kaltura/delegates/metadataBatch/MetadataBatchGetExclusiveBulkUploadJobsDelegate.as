package com.kaltura.delegates.metadataBatch
{
	...
	public class MetadataBatchGetExclusiveBulkUploadJobsDelegate extends WebDelegateBase
	{
		public function MetadataBatchGetExclusiveBulkUploadJobsDelegate(call:KalturaCall, config:KalturaConfig)
		{
			super(call, config);
		}
