package com.kaltura.delegates.metadataBatch
{
	...
	public class MetadataBatchGetExclusiveAlmostDoneRemoteConvertJobsDelegate extends WebDelegateBase
	{
		public function MetadataBatchGetExclusiveAlmostDoneRemoteConvertJobsDelegate(call:KalturaCall, config:KalturaConfig)
		{
			super(call, config);
		}
