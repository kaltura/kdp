package com.kaltura.delegates.metadataBatch
{
	...
	public class MetadataBatchGetExclusiveAlmostDoneDelegate extends WebDelegateBase
	{
		public function MetadataBatchGetExclusiveAlmostDoneDelegate(call:KalturaCall, config:KalturaConfig)
		{
			super(call, config);
		}
