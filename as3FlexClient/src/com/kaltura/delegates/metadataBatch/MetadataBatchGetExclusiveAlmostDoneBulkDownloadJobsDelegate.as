package com.kaltura.delegates.metadataBatch
{
	...
	public class MetadataBatchGetExclusiveAlmostDoneBulkDownloadJobsDelegate extends WebDelegateBase
	{
		public function MetadataBatchGetExclusiveAlmostDoneBulkDownloadJobsDelegate(call:KalturaCall, config:KalturaConfig)
		{
			super(call, config);
		}
