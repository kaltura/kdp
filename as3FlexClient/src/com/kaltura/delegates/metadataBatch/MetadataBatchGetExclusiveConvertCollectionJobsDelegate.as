package com.kaltura.delegates.metadataBatch
{
	...
	public class MetadataBatchGetExclusiveConvertCollectionJobsDelegate extends WebDelegateBase
	{
		public function MetadataBatchGetExclusiveConvertCollectionJobsDelegate(call:KalturaCall, config:KalturaConfig)
		{
			super(call, config);
		}
