package com.kaltura.delegates.metadataBatch
{
	...
	public class MetadataBatchGetExclusiveAlmostDoneConvertCollectionJobsDelegate extends WebDelegateBase
	{
		public function MetadataBatchGetExclusiveAlmostDoneConvertCollectionJobsDelegate(call:KalturaCall, config:KalturaConfig)
		{
			super(call, config);
		}
