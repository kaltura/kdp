package com.kaltura.delegates.metadataBatch
{
	...
	public class MetadataBatchGetExclusivePostConvertJobsDelegate extends WebDelegateBase
	{
		public function MetadataBatchGetExclusivePostConvertJobsDelegate(call:KalturaCall, config:KalturaConfig)
		{
			super(call, config);
		}
