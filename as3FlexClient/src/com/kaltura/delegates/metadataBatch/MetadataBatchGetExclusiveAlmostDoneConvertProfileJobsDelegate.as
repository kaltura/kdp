package com.kaltura.delegates.metadataBatch
{
	...
	public class MetadataBatchGetExclusiveAlmostDoneConvertProfileJobsDelegate extends WebDelegateBase
	{
		public function MetadataBatchGetExclusiveAlmostDoneConvertProfileJobsDelegate(call:KalturaCall, config:KalturaConfig)
		{
			super(call, config);
		}
