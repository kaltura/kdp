package com.kaltura.commands.filesyncImportBatch
{
	...
	import com.kaltura.delegates.filesyncImportBatch.FilesyncImportBatchGetExclusiveStorageDeleteJobsDelegate;
	import com.kaltura.net.KalturaCall;

	public class FilesyncImportBatchGetExclusiveStorageDeleteJobs extends KalturaCall
	{
		 ...
		 **/
		public function FilesyncImportBatchGetExclusiveStorageDeleteJobs( lockKey : KalturaExclusiveLockKey,maxExecutionTime : int,numberOfJobs : int,filter : KalturaBatchJobFilter=null )
		{
		...
		override public function execute() : void
		{
			...
			delegate = new FilesyncImportBatchGetExclusiveStorageDeleteJobsDelegate( this , config );
		}
	}
}
