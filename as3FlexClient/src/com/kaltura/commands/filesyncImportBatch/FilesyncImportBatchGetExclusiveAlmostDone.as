package com.kaltura.commands.filesyncImportBatch
{
	...
	import com.kaltura.delegates.filesyncImportBatch.FilesyncImportBatchGetExclusiveAlmostDoneDelegate;
	...
	public class FilesyncImportBatchGetExclusiveAlmostDone extends KalturaCall
	{
		 ...
		 **/
		public function FilesyncImportBatchGetExclusiveAlmostDone( lockKey : KalturaExclusiveLockKey,maxExecutionTime : int,numberOfJobs : int,filter : KalturaBatchJobFilter=null,jobType : String='null' )
		{
		...
		override public function execute() : void
		{
			...
			delegate = new FilesyncImportBatchGetExclusiveAlmostDoneDelegate( this , config );
		}
	}
}
