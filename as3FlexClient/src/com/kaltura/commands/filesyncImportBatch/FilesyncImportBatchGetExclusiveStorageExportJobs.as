package com.kaltura.commands.filesyncImportBatch
{
	...
	import com.kaltura.delegates.filesyncImportBatch.FilesyncImportBatchGetExclusiveStorageExportJobsDelegate;
	import com.kaltura.net.KalturaCall;

	public class FilesyncImportBatchGetExclusiveStorageExportJobs extends KalturaCall
	{
		 ...
		 **/
		public function FilesyncImportBatchGetExclusiveStorageExportJobs( lockKey : KalturaExclusiveLockKey,maxExecutionTime : int,numberOfJobs : int,filter : KalturaBatchJobFilter=null )
		{
		...
		override public function execute() : void
		{
			...
			delegate = new FilesyncImportBatchGetExclusiveStorageExportJobsDelegate( this , config );
		}
	}
}
