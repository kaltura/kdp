package com.kaltura.commands.filesyncImportBatch
{
	...
	import com.kaltura.delegates.filesyncImportBatch.FilesyncImportBatchGetExclusiveJobsDelegate;
	import com.kaltura.net.KalturaCall;

	public class FilesyncImportBatchGetExclusiveJobs extends KalturaCall
	{
		 ...
		 **/
		public function FilesyncImportBatchGetExclusiveJobs( lockKey : KalturaExclusiveLockKey,maxExecutionTime : int,numberOfJobs : int,filter : KalturaBatchJobFilter=null,jobType : String='null' )
		{
		...
		override public function execute() : void
		{
			...
			delegate = new FilesyncImportBatchGetExclusiveJobsDelegate( this , config );
		}
	}
}
