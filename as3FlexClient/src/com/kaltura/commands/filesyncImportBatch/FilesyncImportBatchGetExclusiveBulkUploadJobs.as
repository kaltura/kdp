package com.kaltura.commands.filesyncImportBatch
{
	...
	import com.kaltura.delegates.filesyncImportBatch.FilesyncImportBatchGetExclusiveBulkUploadJobsDelegate;
	import com.kaltura.net.KalturaCall;

	public class FilesyncImportBatchGetExclusiveBulkUploadJobs extends KalturaCall
	{
		 ...
		 **/
		public function FilesyncImportBatchGetExclusiveBulkUploadJobs( lockKey : KalturaExclusiveLockKey,maxExecutionTime : int,numberOfJobs : int,filter : KalturaBatchJobFilter=null )
		{
		...
		override public function execute() : void
		{
			...
			delegate = new FilesyncImportBatchGetExclusiveBulkUploadJobsDelegate( this , config );
		}
	}
}
