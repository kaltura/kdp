...
package com.kaltura.commands.document
{
	...
	import com.kaltura.delegates.document.DocumentUpdateContentDelegate;
	...
	* 
	**/
	public class DocumentUpdateContent extends KalturaCall
	{
		...
		**/
		public function DocumentUpdateContent( entryId : String,resource : KalturaResource,conversionProfileId : int=int.MIN_VALUE )
		{
			service= 'document';
