package com.kaltura.commands.virusScanBatch
{
	...
	import com.kaltura.delegates.virusScanBatch.VirusScanBatchGetExclusivePostConvertJobsDelegate;
	import com.kaltura.net.KalturaCall;

	public class VirusScanBatchGetExclusivePostConvertJobs extends KalturaCall
	{
		 ...
		 **/
		public function VirusScanBatchGetExclusivePostConvertJobs( lockKey : KalturaExclusiveLockKey,maxExecutionTime : int,numberOfJobs : int,filter : KalturaBatchJobFilter=null )
		{
		...
		override public function execute() : void
		{
			...
			delegate = new VirusScanBatchGetExclusivePostConvertJobsDelegate( this , config );
		}
	}
}
