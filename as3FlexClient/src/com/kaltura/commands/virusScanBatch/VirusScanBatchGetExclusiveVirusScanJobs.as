package com.kaltura.commands.virusScanBatch
{
	...
	import com.kaltura.delegates.virusScanBatch.VirusScanBatchGetExclusiveVirusScanJobsDelegate;
	import com.kaltura.net.KalturaCall;

	public class VirusScanBatchGetExclusiveVirusScanJobs extends KalturaCall
	{
		 ...
		 **/
		public function VirusScanBatchGetExclusiveVirusScanJobs( lockKey : KalturaExclusiveLockKey,maxExecutionTime : int,numberOfJobs : int,filter : KalturaBatchJobFilter=null )
		{
		...
		override public function execute() : void
		{
			...
			delegate = new VirusScanBatchGetExclusiveVirusScanJobsDelegate( this , config );
		}
	}
}
