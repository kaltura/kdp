package com.kaltura.commands.virusScanBatch
{
	...
	import com.kaltura.delegates.virusScanBatch.VirusScanBatchGetExclusiveExtractMediaJobsDelegate;
	import com.kaltura.net.KalturaCall;

	public class VirusScanBatchGetExclusiveExtractMediaJobs extends KalturaCall
	{
		 ...
		 **/
		public function VirusScanBatchGetExclusiveExtractMediaJobs( lockKey : KalturaExclusiveLockKey,maxExecutionTime : int,numberOfJobs : int,filter : KalturaBatchJobFilter=null )
		{
		...
		override public function execute() : void
		{
			...
			delegate = new VirusScanBatchGetExclusiveExtractMediaJobsDelegate( this , config );
		}
	}
}
