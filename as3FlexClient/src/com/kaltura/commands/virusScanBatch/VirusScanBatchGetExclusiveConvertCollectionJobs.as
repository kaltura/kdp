package com.kaltura.commands.virusScanBatch
{
	...
	import com.kaltura.delegates.virusScanBatch.VirusScanBatchGetExclusiveConvertCollectionJobsDelegate;
	import com.kaltura.net.KalturaCall;

	public class VirusScanBatchGetExclusiveConvertCollectionJobs extends KalturaCall
	{
		 ...
		 **/
		public function VirusScanBatchGetExclusiveConvertCollectionJobs( lockKey : KalturaExclusiveLockKey,maxExecutionTime : int,numberOfJobs : int,filter : KalturaBatchJobFilter=null )
		{
		...
		override public function execute() : void
		{
			...
			delegate = new VirusScanBatchGetExclusiveConvertCollectionJobsDelegate( this , config );
		}
	}
}
