package com.kaltura.commands.virusScanBatch
{
	...
	import com.kaltura.delegates.virusScanBatch.VirusScanBatchAddBulkUploadResultDelegate;
	import com.kaltura.net.KalturaCall;

	public class VirusScanBatchAddBulkUploadResult extends KalturaCall
	{
		 ...
		 **/
		public function VirusScanBatchAddBulkUploadResult( bulkUploadResult : KalturaBulkUploadResult,pluginDataArray : Array=null )
		{
		...
		override public function execute() : void
		{
			...
			delegate = new VirusScanBatchAddBulkUploadResultDelegate( this , config );
		}
	}
}
