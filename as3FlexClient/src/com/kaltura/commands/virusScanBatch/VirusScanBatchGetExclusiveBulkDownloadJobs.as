package com.kaltura.commands.virusScanBatch
{
	...
	import com.kaltura.delegates.virusScanBatch.VirusScanBatchGetExclusiveBulkDownloadJobsDelegate;
	import com.kaltura.net.KalturaCall;

	public class VirusScanBatchGetExclusiveBulkDownloadJobs extends KalturaCall
	{
		 ...
		 **/
		public function VirusScanBatchGetExclusiveBulkDownloadJobs( lockKey : KalturaExclusiveLockKey,maxExecutionTime : int,numberOfJobs : int,filter : KalturaBatchJobFilter=null )
		{
		...
		override public function execute() : void
		{
			...
			delegate = new VirusScanBatchGetExclusiveBulkDownloadJobsDelegate( this , config );
		}
	}
}
