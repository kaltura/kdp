...
{
	import com.kaltura.delegates.liveStream.LiveStreamUnregisterMediaServerDelegate;
	...
	**/
	public class LiveStreamUnregisterMediaServer extends KalturaCall
	{
		...
		**/
		public function LiveStreamUnregisterMediaServer( entryId : String,hostname : String,mediaServerIndex : int )
		{
			service= 'livestream';
		...
		override public function execute() : void
		{
			...
			delegate = new LiveStreamUnregisterMediaServerDelegate( this , config );
		}
	}
}
