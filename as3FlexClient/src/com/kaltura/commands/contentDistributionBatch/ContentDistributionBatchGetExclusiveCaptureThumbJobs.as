package com.kaltura.commands.contentDistributionBatch
{
	...
	import com.kaltura.delegates.contentDistributionBatch.ContentDistributionBatchGetExclusiveCaptureThumbJobsDelegate;
	import com.kaltura.net.KalturaCall;

	public class ContentDistributionBatchGetExclusiveCaptureThumbJobs extends KalturaCall
	{
		 ...
		 **/
		public function ContentDistributionBatchGetExclusiveCaptureThumbJobs( lockKey : KalturaExclusiveLockKey,maxExecutionTime : int,numberOfJobs : int,filter : KalturaBatchJobFilter=null )
		{
		...
		override public function execute() : void
		{
			...
			delegate = new ContentDistributionBatchGetExclusiveCaptureThumbJobsDelegate( this , config );
		}
	}
}
