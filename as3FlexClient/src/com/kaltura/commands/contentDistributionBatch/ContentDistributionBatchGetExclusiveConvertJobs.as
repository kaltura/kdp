package com.kaltura.commands.contentDistributionBatch
{
	...
	import com.kaltura.delegates.contentDistributionBatch.ContentDistributionBatchGetExclusiveConvertJobsDelegate;
	import com.kaltura.net.KalturaCall;

	public class ContentDistributionBatchGetExclusiveConvertJobs extends KalturaCall
	{
		 ...
		 **/
		public function ContentDistributionBatchGetExclusiveConvertJobs( lockKey : KalturaExclusiveLockKey,maxExecutionTime : int,numberOfJobs : int,filter : KalturaBatchJobFilter=null )
		{
		...
		override public function execute() : void
		{
			...
			delegate = new ContentDistributionBatchGetExclusiveConvertJobsDelegate( this , config );
		}
	}
}
