package com.kaltura.commands.contentDistributionBatch
{
	...
	import com.kaltura.delegates.contentDistributionBatch.ContentDistributionBatchGetExclusiveJobsDelegate;
	import com.kaltura.net.KalturaCall;

	public class ContentDistributionBatchGetExclusiveJobs extends KalturaCall
	{
		 ...
		 **/
		public function ContentDistributionBatchGetExclusiveJobs( lockKey : KalturaExclusiveLockKey,maxExecutionTime : int,numberOfJobs : int,filter : KalturaBatchJobFilter=null,jobType : String='null' )
		{
		...
		override public function execute() : void
		{
			...
			delegate = new ContentDistributionBatchGetExclusiveJobsDelegate( this , config );
		}
	}
}
