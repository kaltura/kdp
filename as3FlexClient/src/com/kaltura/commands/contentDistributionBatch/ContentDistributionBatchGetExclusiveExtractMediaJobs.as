package com.kaltura.commands.contentDistributionBatch
{
	...
	import com.kaltura.delegates.contentDistributionBatch.ContentDistributionBatchGetExclusiveExtractMediaJobsDelegate;
	import com.kaltura.net.KalturaCall;

	public class ContentDistributionBatchGetExclusiveExtractMediaJobs extends KalturaCall
	{
		 ...
		 **/
		public function ContentDistributionBatchGetExclusiveExtractMediaJobs( lockKey : KalturaExclusiveLockKey,maxExecutionTime : int,numberOfJobs : int,filter : KalturaBatchJobFilter=null )
		{
		...
		override public function execute() : void
		{
			...
			delegate = new ContentDistributionBatchGetExclusiveExtractMediaJobsDelegate( this , config );
		}
	}
}
