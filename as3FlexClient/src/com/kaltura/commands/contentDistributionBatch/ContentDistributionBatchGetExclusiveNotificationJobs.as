package com.kaltura.commands.contentDistributionBatch
{
	...
	import com.kaltura.delegates.contentDistributionBatch.ContentDistributionBatchGetExclusiveNotificationJobsDelegate;
	import com.kaltura.net.KalturaCall;

	public class ContentDistributionBatchGetExclusiveNotificationJobs extends KalturaCall
	{
		 ...
		 **/
		public function ContentDistributionBatchGetExclusiveNotificationJobs( lockKey : KalturaExclusiveLockKey,maxExecutionTime : int,numberOfJobs : int,filter : KalturaBatchJobFilter=null )
		{
		...
		override public function execute() : void
		{
			...
			delegate = new ContentDistributionBatchGetExclusiveNotificationJobsDelegate( this , config );
		}
	}
}
